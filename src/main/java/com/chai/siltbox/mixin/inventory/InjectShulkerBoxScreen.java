...
public abstract class InjectShulkerBoxScreen extends HandledScreen<ShulkerBoxScreenHandler>
{
	public InjectShulkerBoxScreen(ShulkerBoxScreenHandler handler, PlayerInventory inventory, Text title)
	{
