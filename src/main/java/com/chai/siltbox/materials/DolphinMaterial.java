...
public class DolphinMaterial implements ArmorMaterial
{
	public static final DolphinMaterial INSTANCE = new DolphinMaterial();
	...
	{
		return Ingredient.ofItems(SiltItems.PEARLESCENT_BUBBLE);
	}
